...
public class AtAccomplishmentTypesResource {
    ...
    @Timed
    public List<AtAccomplishmentTypes> getAllAtAccomplishmentTypes() {
        log.debug("REST request to get all AtAccomplishmentTypes");
        return atAccomplishmentTypesRepository.findAll();
        }
