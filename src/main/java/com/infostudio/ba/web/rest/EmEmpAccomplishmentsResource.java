...
public class EmEmpAccomplishmentsResource {
    ...
    @Timed
    public List<EmEmpAccomplishments> getAllEmEmpAccomplishments() {
        log.debug("REST request to get all EmEmpAccomplishments");
        return emEmpAccomplishmentsRepository.findAll();
        }
     ...
     * @return the ResponseEntity with status 200 (OK) and the list of emEmpAccomplishments in body
     */
    @GetMapping("/em-emp-accomplishments/byEmployee/{id}")
    @Timed
